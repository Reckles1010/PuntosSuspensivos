document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderDashboard() {
        ...
        document.getElementById('disponibles__count').innerText = `Disponibles (${totalDisponibles})`;
        document.getElementById('vendidos__count').innerText = `Vendidos (${totalVendidos})`;
        document.getElementById('disponibilidad__bar').style.width = `${porcentaje}%`;
        document.getElementById('disponibilidad__percent').innerText = `${porcentaje.toFixed(0)}% disponible`;
    }
